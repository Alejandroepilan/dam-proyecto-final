...
$conexion = conectarDB();
$sql_my_user = "SELECT name, lastname, email, idfiscal, phone, password FROM user WHERE user_id = '$user_id'";
            ...
            <tbody>
              <?php foreach ($transactions as $transaction) : ?>
                <tr>
                  ...
                  <td class="py-2 px-4 border-b"><?php echo $transaction['transaction_currency_name']; ?></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
