...
$sql_transaction_currencys = "SELECT * FROM transaction_currency";
      ...
      <?php foreach ($ongs as $ong) : ?>
        <div id="<?php echo $ong['ong_id']; ?>" class="bg-white mb-16 w-full max-w-2xl p-9 shadow rounded-2xl ring-1 ring-black ring-opacity-5">
          ...
          <div class="flex items-center justify-between mb-9">
            ...
            <div>
            <span class="mr-2"><?php echo $ong['country']; ?></span>
          ...
          <form action="<?php $ruta_actual ?>" method="post" class="flex items-center justify-left ">
            ...
            <select name="transaction_currency_input" class="bg-gray-100 px-4 py-2 rounded-md outline-none mr-6">
              <?php foreach ($transaction_currencys as $transaction_currency) : ?>
                <option value="<?php echo $transaction_currency['transaction_currency_id']; ?>"><?php echo $transaction_currency['code']; ?></option>
              <?php endforeach; ?>
            </select>
...
<?php
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO transaction (user_id, ong_id, currency_id, amount) VALUES ('$user_id', '$ong_id', '$transaction_currency_input', '$transaction_amount_input')";
